...
5. **Replace `.chezmoitemplates/claude/personal.md` (and/or `work.md`), `dot_config/claude/CLAUDE.shared.md`, and `dot_codex/AGENTS.md`** with your own preferences. They currently encode my style; almost certainly not yours.
