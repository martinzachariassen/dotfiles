...
- [`AGENTS.md`](../AGENTS.md) — repo-local brief for AI agents (Claude Code, Copilot) editing this repo. Source of truth; the bridges below all point at it. See [AI tools](ai-tools.md) for the full layering.
