...
| `chezdistill` | Distil this Mac's Claude Code conversations into TheArchive nightly, and render the `MAIN.md` every future session loads. Creates nothing — the vault must already be there. |
